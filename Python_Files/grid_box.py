...
cx =  float(sys.argv[1]) #float(pocket_center[0])
cy =  float(sys.argv[2]) #float(pocket_center[1])
cz =  float(sys.argv[3]) #float(pocket_center[2])

lx =  float(sys.argv[4]) #float(pocket_size[0])
ly =  float(sys.argv[5]) #float(pocket_size[1])
lz =  float(sys.argv[6]) #float(pocket_size[2])
